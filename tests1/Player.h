...
public:
    ...
    void find_pre_post(std::shared_ptr<Node<std::shared_ptr<Player>, PlayerByRank>> root, std::shared_ptr<Player>& player, std::shared_ptr<Node<std::shared_ptr<Player>,
            PlayerByRank>>& pre, std::shared_ptr<Node<std::shared_ptr<Player>, PlayerByRank>>& post, PlayerByRank cond);

    void calc_closest(std::shared_ptr<Node<std::shared_ptr<Player>, PlayerByRank>> root, std::shared_ptr<Player>& player);
    ...
    void set_team(std::shared_ptr<Team> t);

    void setTeamId(int n_id);
